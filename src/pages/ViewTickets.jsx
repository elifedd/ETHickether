  ...
  return (
    <div className='flight-card'>
      ...
      <div className='flight-action'>
        ...
        {openModal && <ConnectWalletModal closeModal={() => setOpenModal(false)} flightTicketPrice={priceInEth} origin={origin} destination={destination} departureTime={departureTime} arrivalTime={departureTime} airline={airline} />}
      </div>
    </div>
  );
}
